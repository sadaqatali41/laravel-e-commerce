                ...
                <div class="col-lg-12">
                    <div class="au-card recent-report">
                        <div class="au-card-inner">
                            <form id="colorAddForm" action="{{ route('admin.color.store') }}" method="post">
                                <div class="row">
                                    <div class="col-sm-3">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm" id="colorAddFormBtn">
        ...
        @case('edit')
            ...
            <div class="row m-t-10">
                <div class="col-lg-12">
                    <div class="au-card recent-report">
                        <div class="au-card-inner">
                            <form id="colorEditForm" action="{{ route('admin.color.update', $color->id) }}" method="post">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="color" class=" form-control-label">Color</label>
                                ...
                                <button type="submit" class="btn btn-primary btn-sm" id="colorEditFormBtn">
                                    <i class="fa fa-dot-circle-o"></i> Submit
                                </button>
                            </form>
                        </div>
...
@push('script')
    <script>
        $(function(){
            ...
            $(document).on('submit', '#colorAddForm', function(e){
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    processData: false,
                    beforeSend: function() {
                        $('#colorAddFormBtn').attr('disabled', true).html('Loading.....');
                    ...
                    error: function(response) {
                        ...
                        $('#colorAddFormBtn').attr('disabled', false).html('<i class="fa fa-dot-circle-o"></i> Submit');
                    },
            ...
            $(document).on('submit', '#colorEditForm', function(e){
                ...
                $.ajax({
                    ...
                    processData: false,
                    beforeSend: function() {
                        $('#colorEditFormBtn').attr('disabled', true).html('Loading.....');
                        $('.status--denied').remove();
                    },
                    error: function(response) {
                        let formErrors = response.responseJSON.errors;
                        ...
                        $('#colorEditFormBtn').attr('disabled', false).html('<i class="fa fa-dot-circle-o"></i> Submit');
                    },
                    success: function(response) {                        
                        window.location.reload();
                    },
